...
export const textStyles = {
  ...
  'body-sm': {
    ...
    weight: '400',
    color: '#000000',
    usage: ['UserTable cells', 'Page descriptions', 'Form inputs', 'Dropdown menus'],
  },
  'body-xs': {
    ...
    weight: '400',
    color: '#666666',
    usage: ['Page subtitles', 'Helper text', 'Empty state messages', 'Badge text'],
  },
  ...
  'label-form': {
    ...
    weight: '500',
    color: '#666666',
    usage: ['UserEditorModal', 'LoginPage', 'ForgotPasswordPage', 'ResetPasswordPage', 'UserTable headers'],
  },
  ...
  'button-md': {
    ...
    size: '14px',
    weight: '500',
    usage: ['Button component', 'NavItem', 'Modal footer buttons', 'Auth buttons'],
  },
  'button-lg': {
