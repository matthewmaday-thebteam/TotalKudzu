    ...
    <div className="space-y-12">
      ...
      <div>
        ...
        <div className="mb-8 p-6 border border-vercel-gray-100 rounded-lg">
          ...
          <div className="mt-4 p-3 bg-vercel-gray-50 rounded-lg">
            <p className="text-xs text-vercel-gray-400">
              <span className="font-medium">Features:</span> Three variants - dateRange (month selection + date text), export (month selection + CSV button), exportOnly (just CSV button).
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="space-y-8">
      <div className="grid gap-6">
        <div className="p-6 border border-vercel-gray-100 rounded-lg">
          ...
          <p className="text-xs text-vercel-gray-400">
            Unified navigation header with NavItem atoms, user avatar, and profile menu.
          </p>
        ...
        <div className="p-6 border border-vercel-gray-100 rounded-lg">
          ...
          <p className="text-xs text-vercel-gray-400">
            UserTable - Data tables with sorting, actions, and row rendering.
          </p>
        ...
        <div className="p-6 border border-vercel-gray-100 rounded-lg">
          ...
          <p className="text-xs text-vercel-gray-400">
            UserEditorModal - Form modals for CRUD operations.
          </p>
